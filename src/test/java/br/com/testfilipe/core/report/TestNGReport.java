package br.com.testfilipe.core.report;
...
public class TestNGReport implements IReporter{
	...
	//This is the customize emailabel report template file path.
		private static final String emailableReportTemplateFile = "./src/com/testFilipe/core/report/template.html";
		...
		public void generateReport(List<XmlSuite> xmlSuites, List<ISuite> suites, String outputDirectory) {
			...
			try
			{
				...
				String customReportTitle = this.getCustomReportTitle("Porto Seguro Automação");
				...
				File targetFile = new File(outputDirectory + "/Execucao_PortoSeguto.html");
